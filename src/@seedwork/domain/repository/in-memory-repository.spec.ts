...
describe('InMemoryRepository Unit Tests', () => {
  ...
  it('should throws an error when entity not found', () => {
    ...
    expect(repository.findById(new UniqueEntityId('855795e2-2064-49b3-94bb-45c193cc01eb'))).rejects.toThrow(
      new NotFoundError(`Entity Not Found using ID 855795e2-2064-49b3-94bb-45c193cc01eb`)
    )
  })
  ...
  it('should throws an error on delete when entity not found', () => {
    ...
    expect(repository.delete(new UniqueEntityId('855795e2-2064-49b3-94bb-45c193cc01eb'))).rejects.toThrow(
      new NotFoundError(`Entity Not Found using ID 855795e2-2064-49b3-94bb-45c193cc01eb`)
    )
  })
