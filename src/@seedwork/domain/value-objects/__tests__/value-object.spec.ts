...
describe('ValueObject Unit Tests', () => {
  ...
  it('should be a immutable object', () => {
    ...
    expect(() => (vo as any).value.prop1 = 'changing').toThrow("Cannot assign to read only property 'prop1' of object '#<Object>'")

    expect(() => (vo as any).value.deep.prop2 = 'changing').toThrow("Cannot assign to read only property 'prop2' of object '#<Object>'")
