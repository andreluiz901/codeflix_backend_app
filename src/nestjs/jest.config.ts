export default {
	...
	moduleNameMapper: {
		'codeflix-backend-app/(.*)$':
			...
			'#seedwork/domain': '<rootDir>/../../../node_modules/codeflix-backend-app/dist/@seedwork/domain/index.js',
			//'#seedwork/(.*)$': `<rootDir>/../../../node_modules/codeflix-backend-app/dist/@seedwork/$1`,
			'#category/domain': '<rootDir>/../../../node_modules/codeflix-backend-app/dist/category/domain/index.js',
