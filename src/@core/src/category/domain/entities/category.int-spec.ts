...
describe('Category Integration Tests', () => {
  ...
  describe('create method', () => {
    it('should a invalid category using name property', () => {
      ...
      expect(() => new Category({ name: "t".repeat(256), })).containsErrorsMessages({
        name: [
          'name must be shorter than or equal to 255 characters'
        ]
      })
    ...
    it('should a invalid category using description property', () => {
      expect(() => new Category({ name: null, description: 5 as any })).containsErrorsMessages({
        description: [
    ...
    it('should a invalid category using isActive property', () => {
      ...
      expect(() => new Category({ name: 'Movie', isActive: '' as any })).containsErrorsMessages({
        isActive: [
  ...
  describe('update method', () => {
    it('should a invalid category using name property', () => {
      ...
      expect(() => category.update('t'.repeat(256), null)).containsErrorsMessages({
        name: [
          'name must be shorter than or equal to 255 characters'
        ]
      })
